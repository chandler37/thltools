    ...
    extends BasePeer
{
        ...
        throws TorqueException
    {
        try
        {
                                        obj.setId(row.getValue(offset + 0).asIntegerObj());
                                            obj.setAddress(row.getValue(offset + 1).asString());
                                            obj.setCity(row.getValue(offset + 2).asString());
                                            obj.setRegion(row.getValue(offset + 3).asString());
                                            obj.setZip(row.getValue(offset + 4).asString());
                                            obj.setCountryId(row.getValue(offset + 5).asIntegerObj());
                            }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Address retrieveByPK(Integer pk)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        ...
        CountryPeer.addSelectColumns(c);
                  ...
                  c.addJoin(AddressPeer.COUNTRY_ID,
            CountryPeer.ID);
