...
public interface LexComponentNode extends ILexComponent {
	/*
	 * public ILexComponent findChild( ILexComponent component ) throws
	 * LexComponentException; public void addChild( ILexComponent component )
	 ...
	 */
	public java.util.List findSiblings(ILexComponent component)
			throws LexComponentException;
