...
public final class displayEntry_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 request.setCharacterEncoding("UTF-8"); 
      ...
      out.write("\t</p>\r\n");
      out.write("\t\r\n");
      out.write("\t<form action=\"/lex/action\">\r\n");
      out.write("\t\t<p id=\"helper\">\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<span class=\"label\">Display</span>:\r\n");
      out.write("\r\n");
      out.write("\t\t\t");
      ...
      if (_jspx_meth_c_out_6(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"cmd\" value=\"displayFull\"/>\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"comp\" value=\"term\"/>\r\n");
      out.write("\t\t\t<input type=\"submit\" value=\"Redisplay\"/>\r\n");
      out.write("\t\t</p>\r\n");
      out.write("\t</form>\r\n");
      out.write("\t\r\n");
  ...
  private boolean _jspx_meth_c_if_1(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t<div id=\"results\" class=\"highlightBox\">\r\n");
  ...
  private boolean _jspx_meth_c_out_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_out_0.setValue(new String("<a ${cls} href='/lex/action?cmd=displayFull&amp;comp=term&amp;metaId=${resultsMapItem.key}'>${ resultsMapItem.value}</a>"));
  ...
  private boolean _jspx_meth_c_out_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_out_2.setValue(new String("<input name='showMeta' type='checkbox' value='true' ${ckd}/> credits |"));
  ...
  private boolean _jspx_meth_c_out_3(PageContext _jspx_page_context)
    ...
    _jspx_th_c_out_3.setValue(new String("<input name='showNotes' type='checkbox' value='true' ${ckd}/> analysis |"));
  ...
  private boolean _jspx_meth_c_out_4(PageContext _jspx_page_context)
    ...
    _jspx_th_c_out_4.setValue(new String("<input name='showTranslations' type='checkbox' value='true' ${ckd}/> translations"));
  ...
  private boolean _jspx_meth_c_out_5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_6, PageContext _jspx_page_context)
    ...
    _jspx_th_c_out_5.setValue(new String("| <input name='showEditOptions' type='checkbox' value='true' ${ckd}/> edit options"));
  ...
  private boolean _jspx_meth_c_out_6(PageContext _jspx_page_context)
    ...
    _jspx_th_c_out_6.setValue(new String("<input type='hidden' name='metaId' value='${ sessionScope.visit.query.entry.metaId }'/>"));
